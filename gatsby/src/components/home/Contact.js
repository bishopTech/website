...
function Contact (props) {
  return (
    <>
      <div className='py-12 bg-darker-blue'>
        ...
        <div className='shadow-xl mt-8 px-8 md:w-full md:flex md:justify-center md:items-center'>
          <form name='contact' method='POST' data-netlify='true' netlify-honeypot='bot-field' className='md:w-3/4 lg:w-3/5 xl:w-1/2' >
            ...
            <button type='submit' className='block w-full rounded bg-light-blue py-3 text-white font-bold shadow'>Submit</button>
